export default function UseCasesSection() {
    const useCases = [
        "Freelancers & Clients", "Small Businesses", "Landlords & Tenants",
        "Teachers & Students", "Coaches & Athletes", "Structured Debates",
        "...and countless more."
    ];
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mt-10 flex flex-wrap items-center justify-center gap-x-3 gap-y-3">
                    {useCases.map((useCase) => (
                        <span key={useCase} className="rounded-full bg-[#5D5FEF]/10 px-4 py-2 text-sm font-semibold leading-6 text-[#5D5FEF]">
                            {useCase}
                        </span>
                    ))}
                </div>
